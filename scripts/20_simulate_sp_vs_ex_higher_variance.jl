...
for j in 1:n_trees
    fpath = string(
        "data/simulations/constant_extinction_spread/", string(j), ".tre"
        )
...
for j in 1:n_trees
    fpath = string(
        "data/simulations/constant_speciation_spread/", string(j), ".tre"
        )
