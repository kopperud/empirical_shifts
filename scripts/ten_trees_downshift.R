...
fpaths <- Sys.glob("output/simulations/grafts/downshift/newick/*.tre")[1:20]
...
ggsave("figures/ten_trees_upshift_downshift.pdf", p, width = 400, height = 700*1.8, units = "mm", limitsize=FALSE)
