...
fpaths <- Sys.glob("output/simulations/grafts/upshift_mu/newick/*.tre")[1:10]
...
ps_middle[[1]] <- ps_middle[[1]] + ggtitle("true extinction = [0.235,0.0]")
ps_right[[1]] <- ps_right[[1]] + ggtitle("true netdiv = [0.09, 0.325]")
...
ggsave("figures/ten_trees_upshift_mu.pdf", p, width = 450, height = 600*1.0, units = "mm", limitsize=FALSE)
